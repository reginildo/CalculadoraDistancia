 ...
 * @author JETTA
 */
public class JFrameOptions extends javax.swing.JFrame {

    /**
     * Creates new form JFrameOptions
     */
    public JFrameOptions() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTabbedPane2.addTab("Appearence", jPanel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameOptions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
